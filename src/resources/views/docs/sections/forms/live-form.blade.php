...
<x-t-form wire:submit.prevent="submitForm">
    ...
    <x-t-field label="Camp select multiple" label-placement="start"  for="f3-sf-2" class="mb-2">
        <x-t-select id="f3-sf-2" wire:model.live="form.select_multi" multiple allowClear :dataOptions="[
            1=>'Opció 1',
            2=>'Opció 2',
            3=>'Opció 3',
            4=>'Opció 4',
