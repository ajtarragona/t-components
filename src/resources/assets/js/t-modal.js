...
document.addEventListener('alpine:init', () => {
    Alpine.data('LivewireUIModal', () => ({
        ...
        getActiveComponentModalAttribute(key) {
            // console.log(this.$wire.get('components')[this.activeComponent]);
        ...
        closeModalOnClickOutside(trigger) {
            // console.log('closeModalOnClickOutside');
            if (this.getActiveComponentModalAttribute('closeOnClickOutside') === false) {
                return;
            }
        ...
        closeModal(force = false, skipPreviousModals = 0, destroySkipped = false) {
            // console.log('closeModal',force , skipPreviousModals , destroySkipped);
            if(this.show === false) {
                return;
            }
            ...
            // console.log('skipPreviousModals',skipPreviousModals);
            ...
            // console.log(this.componentHistory.length);
...
// console.log(this.modalSize);
            Livewire.on('closeModal', (force = false, skipPreviousModals = 0, destroySkipped = false) => {
                // console.log('closeModal wire event', force, skipPreviousModals, destroySkipped);
